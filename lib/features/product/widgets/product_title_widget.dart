      ...
      builder: (context, productProvider, child) {
        return Padding(
          ...
          child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(children: [
              product?.rating != null ? Container(
                ...
                child: Row(mainAxisSize : MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  ...
                  Text((product?.activeReviewsCount != null && product!.activeReviewsCount! > 0) ? ' (${product?.activeReviewsCount})' : '', style: poppinsRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                ]),
              ) : const SizedBox(),
            ...
            Text('unit'.tr, style: poppinsRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeDefault)),
            //Product Price
            Row(children: [
